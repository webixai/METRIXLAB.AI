...
const importedFonts = [
  ...
  'Inter', 'Ubuntu', 'Lato', 'Source Sans Pro', 'Titillium Web',
  'Karla', 'Quicksand', 'Mulish', 'Comfortaa', 'Cabin', 'Prompt',
  'Sora', 'Lexend', 'Jost', 'IBM Plex Sans', 'Georama', 'Oxygen', 'Varela Round', 'Tahoma',
  ...
  'Merriweather', 'Bitter', 'Droid Serif', 'Cormorant Garamond', 'Prata', 'Crimson Text', 'Cambria', 'Georgia',
  ...
  'Rozha One', 'Sohne', 'Spectral', 'Yrsa', 'Zilla Slab', 'Oswald', 'Anton', 'Fredoka One', 'Righteous',
  'Pacifico', 'Lobster', 'Indie Flower', 'Permanent Marker', 'Sacramento', 'Fredoka', 'Alfa Slab One', 'Bungee', 'Rubik Mono One',
